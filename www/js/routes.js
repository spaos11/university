...
//loginadmin
  ...
  // About page
  {
   ...
   {
    path: '/psu/',
    componentUrl: './pages/psu.html',
    name: 'psu',
  },

  {
    path: '/upang/',
    componentUrl: './pages/upang.html',
    name: 'upang',
  },

  {
    path: '/ul/',
    componentUrl: './pages/ul.html',
    name: 'ul',
  },
  ...
  {
    path: '/sti/',
    componentUrl: './pages/sti.html',
    name: 'sti',
  },

  {
    path: '/kingfisher/',
    componentUrl: './pages/kingfisher.html',
    name: 'kingfisher',
  },

  {
    path: '/pimsat/',
    componentUrl: './pages/pimsat.html',
    name: 'pimsat',
  },

   {
    path: '/pass/',
    componentUrl: './pages/pass.html',
    name: 'pass',
  },

  {
    path: '/csjda/',
    componentUrl: './pages/csjda.html',
    name: 'csjda',
  },

  {
    path: '/adelphi/',
    componentUrl: './pages/adelphi.html',
    name: 'adelphi',
  },

   {
    path: '/pcst/',
    componentUrl: './pages/pcst.html',
    name: 'pcst',
  },
   ...
   {
    path: '/vmuf/',
    componentUrl: './pages/vmuf.html',
    name: 'vmuf',
  },

  {
    path: '/goldenwest/',
    componentUrl: './pages/goldenwest.html',
    name: 'goldenwest',
  },

  {
    path: '/ucu/',
    componentUrl: './pages/ucu.html',
    name: 'ucu',
  },

  {
    path: '/stcf/',
    componentUrl: './pages/stcf.html',
    name: 'stcf',
  },

   {
    path: '/nlac/',
    componentUrl: './pages/nlac.html',
    name: 'nlac',
  },

   {
    path: '/dwcu/',
    componentUrl: './pages/dwcu.html',
    name: 'dwcu',
  },

   {
    path: '/wcc/',
    componentUrl: './pages/wcc.html',
    name: 'wcc',
  },

  {
    path: '/pu/',
    componentUrl: './pages/pu.html',
    name: 'pu',
  },

   {
    path: '/scc/',
    componentUrl: './pages/scc.html',
    name: 'scc',
  },
  ...
  {
    path: '/absury/',
    componentUrl: './pages/absury.html',
    name: 'absury',
  },

  //adminasdsajdasgdvasdvhjasdhsa


   {
    path: '/psua/',
    componentUrl: './pages/admin/psua.html',
    name: 'psu',
  },

  {
    path: '/upanga/',
    componentUrl: './pages/admin/upanga.html',
    name: 'upang',
  },

  {
    path: '/ula/',
    componentUrl: './pages/admin/ula.html',
    name: 'ul',
  },
  ...
  {
    path: '/lnua/',
    componentUrl: './pages/admin/lnua.html',
    name: 'lnu',
  },
  ...
  {
    path: '/cdda/',
    componentUrl: './pages/admin/cdda.html',
    name: 'cdd',
  },
  ...
  {
    path: '/stia/',
    componentUrl: './pages/admin/stia.html',
    name: 'sti',
  },

  {
    path: '/kingfishera/',
    componentUrl: './pages/admin/kingfishera.html',
    name: 'kingfisher',
  },

  {
    path: '/pimsata/',
    componentUrl: './pages/admin/pimsata.html',
    name: 'pimsat',
  },

   {
    path: '/passa/',
    componentUrl: './pages/admin/passa.html',
    name: 'pass',
  },

  {
    path: '/csjdaa/',
    componentUrl: './pages/admin/csjdaa.html',
    name: 'csjda',
  },

  {
    path: '/adelphia/',
    componentUrl: './pages/admin/adelphia.html',
    name: 'adelphi',
  },

   {
    path: '/pcsta/',
    componentUrl: './pages/admin/pcsta.html',
    name: 'pcst',
  },
   ...
   {
    path: '/vmufa/',
    componentUrl: './pages/admin/vmufa.html',
    name: 'vmuf',
  },

  {
    path: '/goldenwesta/',
    componentUrl: './pages/admin/goldenwesta.html',
    name: 'goldenwest',
  },

  {
    path: '/ucua/',
    componentUrl: './pages/admin/ucua.html',
    name: 'ucu',
  },

  {
    path: '/stcfa/',
    componentUrl: './pages/admin/stcfa.html',
    name: 'stcf',
  },

   {
    path: '/nlaca/',
    componentUrl: './pages/admin/nlaca.html',
    name: 'nlac',
  },

   {
    path: '/dwcua/',
    componentUrl: './pages/admin/dwcua.html',
    name: 'dwcu',
  },

   {
    path: '/wcca/',
    componentUrl: './pages/admin/wcca.html',
    name: 'wcc',
  },

  {
    path: '/pua/',
    componentUrl: './pages/admin/pua.html',
    name: 'pu',
  },

   {
    path: '/scca/',
    componentUrl: './pages/admin/scca.html',
    name: 'scc',
  },
  ...
  {
    path: '/absurya/',
    componentUrl: './pages/admin/absurya.html',
    name: 'absury',
  },
